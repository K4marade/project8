...
class TestViews(TestCase):
    ...
    #     assert response.status_code == 200  # 302 is redirection status code
    #
    # @pytest.mark.django_db
    # def test_user_register_view(self, client, user_data):
    #
    ...
    # def test_user_profile(self, client, authenticated_user):
    #     profile_url = reverse('profile')
